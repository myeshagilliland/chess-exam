...
public class ChessBoard {
    ...
    private ChessPiece[][] chessBoard = new ChessPiece[8][8]; //[row][col]
    ...
    public void addPiece(ChessPosition position, ChessPiece piece) {
        chessBoard[8-position.getRow()][position.getColumn()-1] = piece;
    }
    ...
    public ChessPiece getPiece(ChessPosition position) {
        return chessBoard[8-position.getRow()][position.getColumn()-1];
    }
